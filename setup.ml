...
(* OASIS_START *)
(* DO NOT EDIT (digest: 94d80d0988c0ca73bc0213edc49b4663) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["PL_util"; "Arith_syntax"; "Arith_util"];
                      lib_pack = false;
                      lib_internal_modules = ["Arith_lexer"; "Arith_parser"];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "£uÂ\153~Lë0m¤\007\158/´³i";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
