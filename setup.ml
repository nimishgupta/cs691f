...
(* OASIS_START *)
(* DO NOT EDIT (digest: f2fdd7e9d674930f7a4421136ae1d147) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "SystemF.ml"; });
               Executable
                 ({
                     cs_name = "testtool";
                     cs_data = PropList.Data.create ();
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "CS691F Support Code Documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\146ý\139ÒW\158\128¯ üHT\156\137QÏ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
